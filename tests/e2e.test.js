...
class MockContentScript {
  ...
  analyzeSelectedAttachments() {
    ...
    const checkboxes = this.dom.querySelectorAll('input[type="checkbox"]:checked');
...
describe('End-to-End Tests - Complete User Workflows', () => {
  ...
  describe('Complete Document Analysis Workflow', () => {
    it('should complete full user workflow from attachment detection to analysis results', async () => {
      ...
      const modal = contentScript.dom.querySelector('.attachment-selector-modal');
    ...
    it('should handle error scenarios gracefully', async () => {
      ...
      expect(errorMessage.textContent).toContain('Please select an attachment first');
    });
  });
  ...
  describe('UI Interaction Tests', () => {
    it('should handle attachment sorting and prioritization in UI', () => {
      ...
      const nonPrdAttachments = contentScript.attachments.filter(a => !a.isPRD);
    ...
    it('should display analysis results in user-friendly format', async () => {
      const attachments = [
        { name: 'security-doc.pdf', type: 'PDF', isPRD: true, relevanceScore: 0.9 }
      ];
  ...
  describe('Performance in User Workflows', () => {
    ...
    it('should maintain responsiveness during analysis', async () => {
      const attachments = [
        { name: 'large-doc.pdf', type: 'PDF', isPRD: true, relevanceScore: 0.9 }
      ];
  ...
  describe('Accessibility and Usability', () => {
    ...
    it('should provide clear visual feedback for user actions', () => {
      ...
      const selectedItem = popupUI.dom.querySelector('.attachment-item.selected');
    ...
    it('should provide meaningful error messages', async () => {
      ...
      const errorMessage = popupUI.dom.querySelector('.error-message');
      expect(errorMessage).toBeDefined();
      expect(errorMessage.textContent).toBe('Please select an attachment first');
    });
  });
});